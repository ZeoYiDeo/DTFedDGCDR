...
class CDRConfig(Config):
    ...
    def _load_internal_config_dict(self, model, model_class, dataset):
        ...
        # sample_init_file = os.path.join(current_path, '../properties/dataset/Douban-MB.yaml')
        # sample_init_file = os.path.join(current_path, '../properties/dataset/Amazon-BM.yaml')
        # sample_init_file = os.path.join(current_path, '../properties/dataset/Amazon-MB.yaml')
        # sample_init_file = os.path.join(current_path, '../properties/dataset/FB-MB.yaml')
        # sample_init_file = os.path.join(current_path, '../properties/dataset/Amazon-commonUser.yaml')
        # sample_init_file = os.path.join(current_path, '../properties/dataset/AmazonElec_AmazonCell-commonUser.yaml')
        # sample_init_file = os.path.join(current_path, '../properties/dataset/AmazonElec_AmazonCloth_commonUser_5-core.yaml')
        # sample_init_file = os.path.join(current_path, '../properties/dataset/AmazonElec_AmazonCloth_commonUser_10-core.yaml')
        # sample_init_file = os.path.join(current_path, '../properties/dataset/AmazonCloth_AmazonElec_commonUser_10-core.yaml')
        # sample_init_file = os.path.join(current_path, '../properties/dataset/AmazonSport_AmazonCloth_commonUser_5-core.yaml')
        sample_init_file = os.path.join(current_path, '../properties/dataset/AmazonCloth_AmazonSport_commonUser_5-core.yaml')
        # sample_init_file = os.path.join(current_path, '../properties/dataset/DoubanMovie_DoubanBook_commonUser_10-core.yaml')
        # sample_init_file = os.path.join(current_path, '../properties/dataset/DoubanBook_DoubanMovie_commonUser_10-core.yaml')
